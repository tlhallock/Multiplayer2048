...
public class LCLobbiesListMessage extends LCLobbyClientMessage
{
	LinkedList<LobbyInfo> lobbies = new LinkedList<>();
	
	public LCLobbiesListMessage() {}

	public LCLobbiesListMessage(JsonParser parser) throws IOException
	{
		int size = -1;
