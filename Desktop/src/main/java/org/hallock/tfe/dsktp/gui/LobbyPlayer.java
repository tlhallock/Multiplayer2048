...
import org.hallock.tfe.msg.LSUpdatePlayer;
 ...
 * @param isAdmin 
     */
    public LobbyPlayer(PlayerInfo player, Connection connection, boolean isAdmin) {
        this.player = player;
...
/**
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
		LSUpdatePlayer.UpdateAction action = null;
		...
		{
		case HumanPlayer:
			action = LSUpdatePlayer.UpdateAction.SetHuman;
			break;
		case Computer:
			action = LSUpdatePlayer.UpdateAction.SetComputer;
			break;
		default:
			throw new RuntimeException("uh oh");
		}
		
		LSUpdatePlayer lsUpdatePlayer = new LSUpdatePlayer(player, action);
		try
		{
			connection.sendMessageAndFlush(lsUpdatePlayer);
		}
		catch (Throwable e)
		{
			e.printStackTrace();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LSUpdatePlayer lsUpdatePlayer = new LSUpdatePlayer(player, LSUpdatePlayer.UpdateAction.Kick);
        try
	{
		connection.sendMessageAndFlush(lsUpdatePlayer);
	}
