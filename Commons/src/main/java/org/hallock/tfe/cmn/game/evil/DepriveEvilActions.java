...
public class DepriveEvilActions extends EvilAction
{
	public DepriveEvilActions(JsonParser parser) throws IOException
	{
		JsonToken next;
	...
	{
		return EvilActionType.DepriveEvilActions;
	}
